...
```bash
git clone [https://github.com/Joyy-cloud/TelecomChurning.git]
cd TelecomChurning
...
* **Dataset Source:** IBM Sample Telco Customer Churn dataset via [Kaggle](https://www.kaggle.com/datasets/blastchar/telco-customer-churn).
